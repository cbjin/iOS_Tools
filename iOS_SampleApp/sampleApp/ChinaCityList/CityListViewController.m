...
- (void)viewDidLoad
{
    ...
    //搜索框
    _searchText = [[UITextField alloc]initWithFrame:CGRectMake(KScreenW * 0.1, 0, KScreenW * 0.85, 40)];
    _searchText.backgroundColor = [UIColor clearColor];
    _searchText.layer.cornerRadius = 20;
    _searchText.layer.borderColor = [[UIColor colorWithRed:220/255.0 green:220/255.0 blue:220/255.0 alpha:1.0] CGColor];
